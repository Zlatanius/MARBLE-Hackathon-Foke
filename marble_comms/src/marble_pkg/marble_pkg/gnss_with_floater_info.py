...
class GNSSWithFloaterInfoPublisher(Node):
    def __init__(self):
        ...
        self.subscriber_1 = self.create_subscription(NavSatFix, '/floater_1/gnss', self.callback, 10)
        self.subscriber_2 = self.create_subscription(NavSatFix, '/floater_2/gnss', self.callback, 10)
        self.subscriber_3 = self.create_subscription(NavSatFix, '/floater_3/gnss', self.callback, 10)
