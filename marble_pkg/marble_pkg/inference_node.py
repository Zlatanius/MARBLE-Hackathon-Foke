...
class InferenceNode(Node):
    def __init__(self):
        ...
        self.subscriber_1 = self.create_subscription(Image, '/floater_1/microscope', self.callback, 10)
        self.subscriber_2 = self.create_subscription(Image, '/floater_2/microscope', self.callback, 10)
        self.subscriber_3 = self.create_subscription(Image, '/floater_3/microscope', self.callback, 10)
